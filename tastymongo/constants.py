...
# Valid query terms.
QUERY_OPERATORS = ['ne', 'gt', 'gte', 'lt', 'lte', 'in', 'nin', 'all', 'size', 'exists']
# QUERY_GEO_OPERATORS = ['within_distance', 'within_spherical_distance', 'within_box', 'within_polygon', 'near', 'near_sphere']
QUERY_MATCH_OPERATORS = ['contains', 'icontains', 'startswith', 'istartswith', 'endswith', 'iendswith', 'exact', 'iexact']

# Use a Dict for O(1) lookups and because filters are also specified dictwise
QUERY_TERMS = dict( [(x, None) for x in ( QUERY_OPERATORS + QUERY_MATCH_OPERATORS ) ] )
